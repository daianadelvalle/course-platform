package ar.com.ada.courseplatform.controller.security;
...
import ar.com.ada.courseplatform.service.security.AuthServices;
...
public class AuthController {
    ...
    public ResponseEntity createAuthToken(@Valid @RequestBody JwtRequestBody body) {
