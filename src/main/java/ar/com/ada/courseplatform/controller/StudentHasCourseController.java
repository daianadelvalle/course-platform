...
public class StudentHasCourseController {
    ...
    @GetMapping({ "/{id}", "/{id}/" }) // localhost:8080/students-has-courses/1 y localhost:8080/students-has-courses/1/ [GET]
    ...
    @PutMapping({ "/{id}", "/{id}/" }) // localhost:8080/students-has-courses/1 y localhost:8080/students-has-courses/1/ [PUT]
    ...
    @DeleteMapping({ "/{id}", "/{id}/" }) // localhost:8080/students-has-courses/1 y localhost:8080/students-has-courses/1/ [DELETE]
